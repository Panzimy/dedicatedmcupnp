## PLEASE READ
This is a [recreation of mod by Pigcart](https://github.com/PigCart/dedicatedmcupnp) without architectury. This is supported on 26.1.2 as is (you just need new Fabric API)
